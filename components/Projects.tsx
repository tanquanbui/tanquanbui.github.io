...
export const projects = [
  {
    ...
    gradient: 'linear-gradient(145deg, #C8B6E8 0%, #ECC6D6 100%)',
    accent: '#8A70C0',
    Decor: FolioDecor,
  },
  {
    ...
    tag: 'Experiment',
    year: '2023',
    swatches: ['#A8CCC0', '#B4C4D8', '#C4D4B8'],
    gradient: 'linear-gradient(145deg, #A6D4BC 0%, #B6C8DC 100%)',
    accent: '#4A8A78',
    Decor: FormaDecor,
  },
  {
    ...
    tag: 'Art',
    year: '2023',
    swatches: ['#F0C4A0', '#E4A888', '#D4906C'],
    gradient: 'linear-gradient(145deg, #F2C2A2 0%, #E2A07C 100%)',
    accent: '#B06038',
    Decor: TempoDecor,
  },
];
